...
then
pull_source "https://github.com/popcornmix/xbmc/archive/6ada11f54d4a5f4fb029b2bd17d20d58f579d52d.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/e50522cdf2845041b604f21987f4ad6467b42965.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
