...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw game.libretro.genplus"
	...
	# pvr.wmc pvr.nextpvr pvr.njoy pvr.mediaportal.tvserver pvr.stalker pvr.pctv pvr.filmon 
	ADDONS_PVR="pvr.vdr.vnsi pvr.hts pvr.vuplus pvr.iptvsimple pvr.octonet pvr.dvbviewer pvr.dvblink pvr.vbox pvr.demo pvr.mythtv pvr.argustv pvr.hdhomerun" # vfs.rar
