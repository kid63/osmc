...
then
pull_source "https://github.com/popcornmix/xbmc/archive/566579c1c5ba9e0210f1c5a4d3fc3387b7a4de11.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/7da578f6ac190bdb1afbda2609159740f658940f.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw game.libretro.genplus"
	#game.moonlight game.libretro.fceumm game.libretro.gw game.libretro.beetle-ps
