...
then
pull_source "https://github.com/popcornmix/xbmc/archive/3ad0510144692c0589266cf74f72a1049a2796a6.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/5c3e9d92dbf5450630bec4e77bacf00f8751c696.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
