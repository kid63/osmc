...
pull_source "https://github.com/xbmc/xbmc/archive/abf12e282428280bd04f4dbc977e2417345f2878.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw game.libretro.genplus"
	...
	ADDONS_PVR="pvr.hts pvr.mediaportal.tvserver pvr.iptvsimple pvr.vdr.vnsi pvr.vuplus pvr.dvbviewer pvr.dvblink pvr.demo pvr.mythtv pvr.hdhomerun" # vfs.rar
