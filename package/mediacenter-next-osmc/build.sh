...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw game.libretro.genplus"
	...
	# pvr.argustv pvr.vbox pvr.octonet pvr.stalker pvr.pctv pvr.filmon 
	ADDONS_PVR="pvr.wmc pvr.nextpvr pvr.njoy pvr.vbox pvr.teleboy pvr.hts pvr.mediaportal.tvserver pvr.iptvsimple pvr.vdr.vnsi pvr.vuplus pvr.dvbviewer pvr.dvblink pvr.demo pvr.hdhomerun" # vfs.rar
