...
then
pull_source "https://github.com/popcornmix/xbmc/archive/6fa346dcfefd583968aba9fc72e4e3d1ba51485b.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/ffc89f649df30ffce8842debb689317da080a438.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
