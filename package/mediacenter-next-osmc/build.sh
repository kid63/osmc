...
if [ "$1" == "rbp1" ] || [ "$1" == "rbp2" ]    
then
pull_source "https://github.com/popcornmix/xbmc/archive/3d626d2dad84a724fc58722219dc8525969112a3.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/41dfdbd6097c4543627a61a7dd1872a9ddd10ade.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
...
game.libretro.o2em game.libretro.prosystem game.libretro.quicknes \
...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw game.libretro.genplus"
	#game.moonlight game.libretro.nestopia game.libretro.pokemini 
