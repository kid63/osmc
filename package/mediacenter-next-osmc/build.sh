...
then
pull_source "https://github.com/popcornmix/xbmc/archive/21c4ca3e37b989c5ef9ef1e313e02e1e512b1866.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/42591d7f796dba851579cbccbb6ba9dbbf2a4b38.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw"
	...
	ADDONS_PVR="pvr.argustv pvr.demo pvr.dvblink pvr.dvbviewer pvr.filmon pvr.hdhomerun pvr.hts pvr.iptvsimple pvr.mediaportal.tvserver pvr.nextpvr pvr.njoy pvr.pctv pvr.stalker pvr.vbox pvr.vuplus pvr.wmc pvr.vdr.vnsi pvr.octonet pvr.mythtv vfs.rar"
