...
if [ "$1" == "rbp1" ] || [ "$1" == "rbp2" ]    
then
pull_source "https://github.com/popcornmix/xbmc/archive/779da8d0396063e002b5c1dd5bb5776129c280d9.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/fa695e0f8969db955983f2da602834a453346c05.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
...
then
	...
	handle_dep "libssl-dev" #"libssl1.0-dev"
...
# Remove  game.libretro.dosbox game.libretro.mame game.libretro.bsnes-mercury-accuracy game.libretro.mupen64plus game.libretro.pcsx-rearmed
	...
	COMMON_DEPENDS="libfstrcmp0, libxkbcommon0, libinput10, xz-utils, libiso9660-8, niceprioritypolicy-osmc, mediacenter-send-osmc, libssh-4, libavahi-client3, python, python-imaging, python-unidecode, libsmbclient, libjpeg62-turbo, libsqlite3-0, libtinyxml2.6.2v5, libmad0, libmicrohttpd12, libyajl2, libmariadbclient18, libasound2, libxml2, liblzo2-2, libxslt1.1, libpng16-16, libsamplerate0, libtag1v5-vanilla, libfribidi0, libgif7, libcdio13, libpcrecpp0v5, libfreetype6, libvorbis0a, libvorbisenc2, libcurl3, libssl1.1, libplist3, avahi-daemon, policykit-1, mediacenter-addon-osmc (>= 3.0.39), mediacenter-skin-osmc, libcrossguid0, libcap2-bin"
