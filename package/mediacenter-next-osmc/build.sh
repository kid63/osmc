...
then
pull_source "https://github.com/popcornmix/xbmc/archive/47713092c239526e332c3c035bd3c3dfa5a74bf5.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/95762bd861e66713f8e69f6e667f98693a40ea9a.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw game.libretro.genplus"
	# game.libretro.beetle-psx game.libretro.beetle-psx game.moonlight game.libretro.fceumm"
	...
	# pvr.argustv pvr.octonet pvr.stalker pvr.pctv pvr.filmon 
	ADDONS_PVR="pvr.octonet pvr.zattoo pvr.vbox pvr.wmc pvr.nextpvr pvr.njoy pvr.teleboy pvr.hts pvr.mediaportal.tvserver pvr.iptvsimple pvr.vdr.vnsi pvr.vuplus pvr.dvbviewer pvr.dvblink pvr.demo pvr.hdhomerun" # vfs.rar
