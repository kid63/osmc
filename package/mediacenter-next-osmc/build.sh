...
then
pull_source "https://github.com/popcornmix/xbmc/archive/8a671e690bfa45be67439e67e79e9abf6b4bc29e.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/4dae235b8fc6711b697fdd8bf049e7ff40008473.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw game.libretro.genplus"
	...
	# pvr.iptvsimple pvr.hts pvr.wmc pvr.nextpvr pvr.njoy pvr.mediaportal.tvserver pvr.stalker pvr.pctv pvr.filmon 
	ADDONS_PVR="pvr.vdr.vnsi pvr.vuplus pvr.octonet pvr.dvbviewer pvr.dvblink pvr.vbox pvr.demo pvr.mythtv pvr.argustv pvr.hdhomerun" # vfs.rar
