...
then
pull_source "https://github.com/popcornmix/xbmc/archive/b09f7828ad4c40b0fc2d11de4db2ca225a6e33b1.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/ee7f71f847c054ecc779261cf05abdb39dcb3f7c.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw game.libretro.genplus"
	...
	# pvr.argustv pvr.vbox pvr.octonet pvr.wmc pvr.nextpvr pvr.njoy pvr.stalker pvr.pctv pvr.filmon 
	ADDONS_PVR="pvr.zattoo pvr.hts pvr.mediaportal.tvserver pvr.iptvsimple pvr.vdr.vnsi pvr.vuplus pvr.dvbviewer pvr.dvblink pvr.demo pvr.mythtv pvr.hdhomerun" # vfs.rar
