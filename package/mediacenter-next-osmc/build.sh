...
then
pull_source "https://github.com/popcornmix/xbmc/archive/0188799272fbd5c10132c6a929d765bb61642b70.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/794694a6c276574be8ef23265fcc5f4502e296dc.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw game.libretro.genplus"
	...
	# pvr.vuplus pvr.wmc pvr.nextpvr pvr.njoy pvr.vdr.vnsi pvr.hts pvr.mythtv pvr.iptvsimple pvr.mediaportal.tvserver pvr.argustv pvr.stalker pvr.pctv pvr.demo pvr.filmon pvr.hdhomerun
	ADDONS_PVR="pvr.octonet pvr.dvbviewer pvr.dvblink pvr.vbox" # vfs.rar
