...
then
pull_source "https://github.com/popcornmix/xbmc/archive/7d2dc0a18753da8bf21cc2888b60b4803d31f7ed.tar.gz" "$(pwd)/src"
API_VERSION="18"
...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw"
	...
	ADDONS_PVR="pvr.argustv pvr.demo pvr.dvblink pvr.filmon pvr.hdhomerun pvr.hts pvr.nextpvr pvr.njoy pvr.pctv pvr.stalker pvr.vbox pvr.vuplus pvr.wmc pvr.vdr.vnsi vfs.rar"
