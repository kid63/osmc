...
then
pull_source "https://github.com/popcornmix/xbmc/archive/35925be7ff4e9ee911387a873f7c01387f3a38ee.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/27a989ee891752cf85c71bc8154c9b3e29eef542.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
...
game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.libretro.dinothaw"
	...
	ADDONS_PVR="pvr.argustv pvr.demo pvr.dvblink pvr.dvbviewer pvr.filmon pvr.hdhomerun pvr.hts pvr.iptvsimple pvr.mediaportal.tvserver pvr.nextpvr pvr.njoy pvr.pctv pvr.stalker pvr.vbox pvr.vuplus pvr.wmc pvr.vdr.vnsi" #pvr.mythtv
