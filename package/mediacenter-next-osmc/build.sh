...
then
pull_source "https://github.com/popcornmix/xbmc/archive/fdfe75d9a980a100d754a67aaa59a51c918e4323.tar.gz" "$(pwd)/src"
API_VERSION="18"

#use xbmc top of tree for vero builds
else
pull_source "https://github.com/xbmc/xbmc/archive/8988343d2b476dd1621cc908635d3b58306bea85.tar.gz" "$(pwd)/src"
API_VERSION="18"
fi
